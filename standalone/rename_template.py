...
It renames all the occurrences of DiffLab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the DiffLab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "DiffLab", "DiffLab"),
            os.path.join(root_dir_path, "exts", "DiffLab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "DiffLab"), os.path.join(root_dir_path, "exts", new_name))
